...
//     // Explicitly check for availability a t main library
...
// used short-circuiting, nullish coalescing, and Optional Chaining and updated this code.
const collection = []
...
function addBookToCollection(title, author, yearPublished, libraryData) {
    ...
    const availability = libraryData?.locations?.mainLibrary
        ? 'Available'
        : 'Not Available'
